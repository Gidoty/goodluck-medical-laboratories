  ...
  return (
    <div className="card p-5">
      <div className="mb-4 flex items-center justify-between">
        <h3 className="font-display text-base font-bold text-navy">New Service</h3>
      ...
      <form onSubmit={onSubmit} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        ...
        <input
          required
          placeholder="Category (e.g. Diagnostics)"
          value={form.category}
        ...
        <input
          required
          placeholder="Price (e.g. From ₦3,000)"
          value={form.price}
          onChange={(e) => setForm({ ...form, price: e.target.value })}
          className="rounded-lg border border-border bg-off px-3.5 py-2.5 text-sm outline-none focus:border-blue sm:col-span-2"
        />
        <textarea
          required
